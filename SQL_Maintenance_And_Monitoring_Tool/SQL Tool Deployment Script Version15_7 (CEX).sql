/*
  ...
  DETAILS ABOUT THIS SCRIPT:  
	- CEX Version for national servers
	- This version is capable of copying 2nd backup copies to Cloud or SAN or NoWhere   
	- Restriction for certain users to access SQL using SSMS and auding on configuration tables in EPOS2000 database
	- Fixed the date format issue ...uk date format i.e. 101 ....which was not trigger delete backup files
*/
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Enable_TempDB_contention_alerts')
     INSERT INTO [SQL_ADMIN].[SQLMantainence].[DBMantainenceConfiguration]  ([configurationType],[VALUE] ,[IsDeleted],COMMENTS) VALUES ('Enable_TempDB_contention_alerts',0,0,'Flag for Enable_TempDB_contention_alerts. alert if Average TempDB writes >= 20 MS')
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForSSASbackupInDays') 
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForSSASbackupInDays','15',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForFullbackupInDays')  
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForFullbackupInDays','15',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForDiffbackupInDays')  
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForDiffbackupInDays','14',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForTLogbackupInDays')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForTLogbackupInDays','4',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForMonthlybackupInDays')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForMonthlybackupInDays','15',0)
UPDATE   [SqlMantainence].[DBMantainenceConfiguration] SET COMMENTS = 'expected value = {numeric value in days}' WHERE [configurationType] = 'RetentionPeriodForMonthlybackupInDays' 

IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'RetentionPeriodForYearlybackupInDays')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('RetentionPeriodForYearlybackupInDays','15',0)
UPDATE   [SqlMantainence].[DBMantainenceConfiguration] SET COMMENTS = 'expected value = {numeric value in days}' WHERE [configurationType] = 'RetentionPeriodForYearlybackupInDays' 
...
/*
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Full_BackupFolder_ForSecondBackupJob')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('Full_BackupFolder_ForSecondBackupJob','?',0)
UPDATE   [SqlMantainence].[DBMantainenceConfiguration] SET COMMENTS = 'expected value = {absolute path / network folder path WHERE FULL will be taken}' WHERE [configurationType] = 'Full_BackupFolder_ForSecondBackupJob' 
*/
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Monthly_BackupFolder')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('Monthly_BackupFolder','?',0)
UPDATE   [SqlMantainence].[DBMantainenceConfiguration] SET COMMENTS = 'expected value= {Monthly Backup Folder Path}' WHERE [configurationType] = 'Monthly_BackupFolder'

IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Yearly_BackupFolder')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('Yearly_BackupFolder','?',0)
UPDATE   [SqlMantainence].[DBMantainenceConfiguration] SET COMMENTS = 'expected value= {Yearly Backup Folder Path}' WHERE [configurationType] = 'Yearly_BackupFolder'
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'DBNameForTrackingSpaceUsage')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('DBNameForTrackingSpaceUsage','EPOS2000',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Database_Catalogue_Alert_Required')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('Database_Catalogue_Alert_Required','0',0)
...
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'Enable_Blocking_Alerts')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted]) VALUES ('Enable_Blocking_Alerts','1',0)
...
SET @LastDeploymentDetails =  '(Version 15.7) => Deployed By ' + SUSER_NAME() + ' on ' + Cast(getdate() as Varchar(100)) 
...
/*
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'DatabaseName_ForSecondBackupJob' AND VALUE = '?')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted],Comments) VALUES ('DatabaseName_ForSecondBackupJob','?',0,'Database Name - to be backed by by 2nd job for FULL Backup')
*/
	
IF NOT EXISTS(SELECT  [configurationType] FROM [SqlMantainence].[DBMantainenceConfiguration] WHERE [configurationType] = 'SecondaryBackupDestination')
	INSERT INTO [SQL_ADMIN].[SqlMantainence].[DBMantainenceConfiguration] ([configurationType], [VALUE],[IsDeleted],Comments) VALUES ('SecondaryBackupDestination','N/A',0,'Expected Value = AWS/SAN/N/A')
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN CATCH
				...
				INSERT INTO SQLMANTAINENCE.DBMANTAINENCELOG VALUES (GETDATE(),'FULL-BACKUP','SSAS Backup failed for the database: '+@DBName + ' (' + ERROR_MESSAGE() + ')','C');
				EXECUTE [SQLMANTAINENCE].[LOG_ERROR] 'SP_MantainencePlanScriptForFullBackupOfSSASDatabases','SSAS-BACKUP'
			END CATCH
			SELECT @i += 1
		END  -- END OF WHILE LOOP
...
BEGIN
	...
	Declare @TLOGBackupFolder1 varchar(1000)
	IF Left(@TLOGBackupFolder,1) = '\' 
	BEGIN
		exec xp_cmdshell 'net use z: /delete'
		SET @TLOGBackupFolder1 = 'net use z: ' +  @TLOGBackupFolder
		exec xp_cmdshell @TLOGBackupFolder1
		SET @TLOGBackupFolder1 = 'z:'
	END
	ELSE
		SET @TLOGBackupFolder1 = @TLOGBackupFolder
	...
	BEGIN TRY
		...
		SELECT @CmdStrSourceInfo = 'dir /O-S /-C /A-D "' + @TLOGBackupFolder1 + '"'        
		SELECT @CmdStrSource = 'dir /B "' + @TLOGBackupFolder1 + '"'  
		   ...
		   IF(CONVERT(DATE,@fileRetentionDate,101) <= CONVERT(DATE,GETDATE(),101))
			...
			BEGIN
			 ...
			 BEGIN TRY
			   ...
			   SET @inpath = 'del  /Q "'+@TLOGBackupFolder1 +'\'+@filename+'.'+@filetype+'"'
					   ...
					   BEGIN
							 ...
							 BEGIN
							  ...
							  BEGIN			 
									...
									-- ****************************************************************
									IF @BACKUPDRIVE = 'http'   
										SET @SQL = 'BACKUP DATABASE [' + @DBNAME + '] TO URL = ''' +  @FULL_BACKUPFOLDER1 + '/' + @DBNAME + '@' +  
											CAST(DATEPART(YEAR,GETDATE()) AS VARCHAR(4)) + RIGHT('0'+CAST(DATEPART(MONTH,GETDATE()) AS VARCHAR(2)),2) + 
											RIGHT('0'+CAST(DATEPART(DAY,GETDATE()) AS VARCHAR(2)),2) + '_' + RIGHT('0'+CAST(DATEPART(HOUR,GETDATE()) AS VARCHAR(2)),2) + 
											RIGHT('0'+CAST(DATEPART(MINUTE,GETDATE()) AS VARCHAR(2)),2) + '.BAK'' 
											WITH CREDENTIAL = ''SQLBackupCreds'', CHECKSUM, INIT'
									ELSE
										SET @SQL = 'BACKUP DATABASE [' + @DBNAME + '] TO DISK = ''' +  @FULL_BACKUPFOLDER1 + '\' + @DBNAME + '@' +  
											CAST(DATEPART(YEAR,GETDATE()) AS VARCHAR(4)) + RIGHT('0'+CAST(DATEPART(MONTH,GETDATE()) AS VARCHAR(2)),2) + 
											RIGHT('0'+CAST(DATEPART(DAY,GETDATE()) AS VARCHAR(2)),2) + '_' + RIGHT('0'+CAST(DATEPART(HOUR,GETDATE()) AS VARCHAR(2)),2) + 
											RIGHT('0'+CAST(DATEPART(MINUTE,GETDATE()) AS VARCHAR(2)),2) + '.BAK'' WITH  CHECKSUM, INIT'
			...
			BEGIN	
				...
				BEGIN
					 ...
					 BEGIN TRY
							...
							IF @BackupDrive = 'http'
								SET @SQL = 'BACKUP DATABASE [' + @DBName + '] 
									TO URL = ''' +  @Full_BackupFolder1 + '/' + @DBName + '@' +  
									Cast(DATEPART(YEAR,getdate()) as varchar(4)) + RIGHT('0'+Cast(DATEPART(MONTH,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(DAY,getdate()) as varchar(2)),2) + '_' + RIGHT('0'+Cast(DATEPART(HOUR,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(MINUTE,getdate()) as varchar(2)),2) + '.bak'' 
									WITH  CREDENTIAL = ''SQLBackupCreds'', CHECKSUM, INIT'
					...
					BEGIN TRY 
						IF @BackupDrive = 'http'
							SET @SQL = 'BACKUP DATABASE [' + @DBName + '] 
									TO URL = ''' +  @Diff_BackupFolder1 + '/' + @DBName + '@' +  
									Cast(DATEPART(YEAR,getdate()) as varchar(4)) + RIGHT('0'+Cast(DATEPART(MONTH,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(DAY,getdate()) as varchar(2)),2) + '_' + RIGHT('0'+Cast(DATEPART(HOUR,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(MINUTE,getdate()) as varchar(2)),2) + '.bak'' 
						...
						ELSE
							SET @SQL = 'BACKUP DATABASE [' + @DBName + '] 
									TO DISK = ''' +  @Diff_BackupFolder1 + '\' + @DBName + '@' +  
									Cast(DATEPART(YEAR,getdate()) as varchar(4)) + RIGHT('0'+Cast(DATEPART(MONTH,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(DAY,getdate()) as varchar(2)),2) + '_' + RIGHT('0'+Cast(DATEPART(HOUR,getdate()) as varchar(2)),2) + 
									RIGHT('0'+Cast(DATEPART(MINUTE,getdate()) as varchar(2)),2) + '.bak'' 
			...
			BEGIN	
				...
				BEGIN
					...
					BEGIN TRY 
						...
						ELSE
							SET @SQL = 'BACKUP LOG [' + @DBName + '] TO DISK = ''' +  @Tlog_BackupFolder1 + '\' + @DBName + '@' +  
								CAST(DATEPART(YEAR,GETDATE()) AS VARCHAR(4)) + RIGHT('0'+CAST(DATEPART(MONTH,GETDATE()) AS VARCHAR(2)),2) + 
								RIGHT('0'+CAST(DATEPART(DAY,GETDATE()) AS VARCHAR(2)),2) + '_' + RIGHT('0'+CAST(DATEPART(HOUR,GETDATE()) AS VARCHAR(2)),2) + 
								RIGHT('0'+CAST(DATEPART(MINUTE,GETDATE()) AS VARCHAR(2)),2) + '.TRN'''
...
INSERT INTO @tblDatabasesToReOrganize
       ...
       WHERE  Is_Read_Only = 0 AND State_Desc = 'ONLINE' AND source_database_id IS NULL AND Is_In_StandBy = 0 AND Database_ID > 4 AND Name NOT LIKE '%_TOBEDELETED%' AND Name NOT in ('ReportServerTempDB','ReportServer')
...
BEGIN
              ...
              SELECT @SQL =   
                     'Use [' + @CurrentDBName +  '];' +              
                     'SELECT DISTINCT 
					 CONCAT('';Alter Index ['', IDX.Name, ''] On ['', SCH.NAME, ''].['' , OBJ.NAME, ''] REBUILD WITH (FILLFACTOR = 95)'') 
                     ...
                     WHERE OBJ.Type IN (''U'',''V'')  AND IDX.TYPE <> 0 AND IDX.Name IS NOT NULL AND ps.avg_fragmentation_in_percent > 30 and IPRT.ROWS > 1000'
					 + ' union all ' + 
					  
                    'SELECT DISTINCT 
					 CONCAT('';Alter Index ['', IDX.Name, ''] On ['', SCH.NAME, ''].['' , OBJ.NAME, ''] REORGANIZE '') 
                     FROM [' + @CurrentDBName +  '].sys.indexes IDX WITH(NOLOCK)          
						 INNER JOIN [' + @CurrentDBName +  '].sys.index_columns as ic ON idx.object_id = ic.object_id AND idx.index_id = ic.index_id     
						 INNER JOIN [' + @CurrentDBName +  '].SYS.OBJECTS OBJ WITH(NOLOCK) ON IDX.OBJECT_ID = OBJ.OBJECT_ID 
						 INNER JOIN [' + @CurrentDBName +  '].SYS.SCHEMAS SCH ON OBJ.SCHEMA_ID = SCH.SCHEMA_ID
						 INNER JOIN  [' + @CurrentDBName +  '].sys.dm_db_index_physical_stats (DB_ID(''' + @CurrentDBName +  '''),NULL,NULL,NULL,NULL) ps on (IDX.OBJECT_ID=ps.OBJECT_ID and idx.index_id=ps.index_id  and ps.alloc_unit_type_desc = ''IN_ROW_DATA'')
						 INNER JOIN sys.partitions IPRT ON idx.object_id = iprt.object_id and idx.index_id = iprt.index_id  and ps.partition_number=IPRT.partition_number
                     WHERE  OBJ.Type IN (''U'',''V'')  AND IDX.TYPE <> 0 AND IDX.Name IS NOT NULL AND ps.avg_fragmentation_in_percent > 5 AND ps.avg_fragmentation_in_percent <= 30 and IPRT.ROWS > 1000'
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Step1- Execute SSAS database(s) backup]    Script Date: 5/20/2015 2:57:25 AM ******/
...
DECLARE @MailRecipients varchar(2000)
SELECT Top 1 @MailRecipients =  [VALUE] FROM sql_admin.SQLMantainence.DBMantainenceConfiguratiON  WITH(NOLOCK) WHERE ConfigurationType=''EmailRecipient''
...
DECLARE @JobName VarChar(1000) 
SET @Enabled = 0 -- By Default False
SET @JobName = 'SQLMantainence_MonthlyBackup'
IF EXISTS(SELECT Name,enabled FROM msdb.dbo.sysjobs WHERE name = @JobName AND Enabled = 1)
	SET @Enabled = 1

IF  EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'SQLMantainence_MonthlyBackup')
	EXEC msdb.dbo.sp_delete_job @job_name=N'SQLMantainence_MonthlyBackup', @delete_unused_schedule=1

BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 9/2/2015 12:43:16 PM ******/
IF NOT EXISTS (SELECT name FROM msdb.dbo.syscategories WHERE name=N'[Uncategorized (Local)]' AND category_class=1)
BEGIN
EXEC @ReturnCode = msdb.dbo.sp_add_category @class=N'JOB', @type=N'LOCAL', @name=N'[Uncategorized (Local)]'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
DECLARE @jobId BINARY(16)
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'SQLMantainence_MonthlyBackup', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=0, 
		@notify_level_netsend=0, 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Step1- Execute Monthly backup]    Script Date: 9/2/2015 12:43:17 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Step1- Execute Monthly backup', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'exec [SqlMantainence].[SP_MantainencePlanScriptForMonthlyBackup]', 
		@database_name=N'SQL_ADMIN', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Step 2 - Copy backups to S3 (cloud folder)]    Script Date: 9/2/2015 12:43:17 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Step 2 - Copy backups to S3 (cloud folder)', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
...
SELECT TOP 1 @BackupFolder = VALUE FROM SQL_ADMIN.SQLMANTAINENCE.DBMANTAINENCECONFIGURATION WITH(NOLOCK) WHERE configurationType = ''Monthly_BackupFolder''
Select @BackupRootFolder = substring(@BackupFolder,1,(Len(@BackupFolder) - CharIndex(''\'',Reverse(@BackupFolder),1)))


IF IsNull(@SecondaryBackupDestination,'''') = ''SAN''
	SELECT @sql = ''powershell.exe -nologo -ExecutionPolicy Bypass -file "C:\DBA\CopyBackupToSAN\CopyBackupToSAN.ps1" "'' + @BackupFolder + ''" "'' + @@ServerName + ''\mssql\Monthly" "backups" "dyon5aEsQQ57" ''
ELSE IF IsNull(@SecondaryBackupDestination,'''') = ''AWS''
	SELECT @sql = ''powershell.exe -nologo -ExecutionPolicy Bypass -file "C:\DBA\CopyBackupToS3\CopyBackupToS3.ps1" "mssql" "'' + @BackupRootFolder +''" "cYhabzAaXTxg9dZYzxK7Y/5w6Hm9B5j9akQk9Uku" ''
ELSE
    SELECT @sql = ''''
...
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Schedule for monthly backups', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=64, 
		@freq_subday_type=1, 
		...
		@active_start_date=20150401, 
		@active_end_date=99991231, 
		@active_start_time=20100, 
		@active_end_time=235959, 
		@schedule_uid=N'5083b369-a990-4171-8121-1d8842e5fdbd'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobserver @job_id = @jobId, @server_name = N'(local)'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
COMMIT TRANSACTION
...
/*
-- Second full backup job is not required for CEX ....hence this is commented / removed from deployment 
...
DECLARE @JobName VarChar(1000) 
SET @Enabled = 0 -- By Default False
SET @JobName = 'SQLMantainence_FullBackup_ForSecondBackupJob'
IF EXISTS(SELECT Name,enabled FROM msdb.dbo.sysjobs WHERE name = @JobName AND Enabled = 1)
	SET @Enabled = 1

IF  EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'SQLMantainence_FullBackup_ForSecondBackupJob')
	EXEC msdb.dbo.sp_delete_job @job_name=N'SQLMantainence_FullBackup_ForSecondBackupJob', @delete_unused_schedule=1


BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 12/10/2014 12:22:05 ******/
IF NOT EXISTS (SELECT name FROM msdb.dbo.syscategories WHERE name=N'[Uncategorized (Local)]' AND category_class=1)
BEGIN
EXEC @ReturnCode = msdb.dbo.sp_add_category @class=N'JOB', @type=N'LOCAL', @name=N'[Uncategorized (Local)]'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
DECLARE @jobId BINARY(16)
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'SQLMantainence_FullBackup_ForSecondBackupJob', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=0, 
		@notify_level_netsend=0, 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [step1 - Execute Full backup]    Script Date: 12/10/2014 12:22:05 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'step1 - Execute Full backup', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=4, 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'exec [sqlMantainence].[SP_MantainencePlanScriptForFullBackup_ForSecondBackupJob]', 
		@database_name=N'SQL_ADMIN', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [step2 - ReExecute Full Backup to ensure all backup are taken]    Script Date: 12/10/2014 12:22:05 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'step2 - ReExecute Full Backup to ensure all backup are taken', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Step 3 - Check Backup Failure Status]    Script Date: 12/10/2014 12:22:05 ******/
...
EXEC @RETURNCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @RETURNCode <> 0) GOTO QuitWithRollback
EXEC @RETURNCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ADHOC BACKUP execution', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
...
GO
	...
	declare @INTValue FLOAT, @strAlertValue nvarchar(4000)
...
*/
 ...
 -- extended event is allowed only in SQL Server 2012....checking if older version
...
BEGIN
	...
	ADD TARGET package0.ring_buffer(SET max_events_limit=(500),max_memory=(4096))
	WITH (MAX_MEMORY=4096 KB,EVENT_RETENTION_MODE=ALLOW_SINGLE_EVENT_LOSS,MAX_DISPATCH_LATENCY=30 SECONDS,MAX_EVENT_SIZE=0 KB,MEMORY_PARTITION_MODE=NONE,TRACK_CAUSALITY=OFF,STARTUP_STATE=OFF)
END   -- extended event is allowed only in SQL Server 2012....checking if older version
GO
